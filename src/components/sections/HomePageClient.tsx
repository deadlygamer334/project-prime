 ...
 * Extracted from page.tsx so the page route can be a Server Component,
 * enabling SSR for the static shell and reducing TTFB / LCP.
 */
export default function HomePageClient() {
    ...
    return (
        <div className="min-h-screen flex flex-col transition-colors duration-300 text-foreground">
            ...
            <main id="main-content" className="container mx-auto flex-grow py-4 max-md:landscape:py-2 px-6 relative z-10 flex flex-col justify-center pb-24 md:pb-4">
                <div className="grid grid-cols-1 gap-6 max-md:landscape:gap-4 md:gap-8 max-md:landscape:grid-cols-2 md:grid-cols-2 items-start">
                    ...
                    <div className={`flex flex-col gap-6 ${settings.dashboardLayout === "reversed" ? "" : "md:order-2"}`}>
                        <GlobalErrorBoundary moduleName="Focus Engine">
                            {/* PomodoroPanel is hoisted to layout.tsx and portaled into this div */}
